...
<body>
	...
	<div class="main-suggestions" id="main-suggestions">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-9 col-md-9">
					<div class="panel panel-default">
						...
						<?php
						 $query=mysql_query(" select user.fristname,user.lastname,user.email,suggestion.subject,suggestion.suggestion,suggestion.ondate,user.profile_picture from user join suggestion where user.email=suggestion.email LIMIT 41,61") or die('suggestion    table selection query error');
	   	...
	   	?>
							...
							<table class="table">
								<tbody>
									...
									<tr>
										...
										<img src="../profile_pictures/<?php echo $rows[0];?>" class="img-responsive img-circle">
										...
										<td><a href="deletesuggestion.php?email=<?php echo $rows[2];?>&&page=<?php echo 'suggestion2.php';?>" onclick="return window.confirm('Are you sure to delete')"> <button type="button" class="btn btn-danger">Delete</button></a></td>
									</tr>
						...
						echo "Suggestion is Less Then 40";
					}
					?>
					</div>
				</div>
 ...
 <!--pagenation -->
  ...
  <a href="suggestion1.php">&laquo;</a>
  <a   href="suggestions.php">1</a>
  <a    href="suggestion1.php">2</a>
  <a class="active" href="suggestion2.php">3</a>
