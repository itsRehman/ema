		...
		<div class="container">
			<div class="row">
						...
						if(mysql_num_rows($query)>0){
							...
							<div class="row pic-col-div">
								...
								<div class="col-md-3">
									...
									<a href="admindelete_event.php?eventid=<?php echo $rows[0];?>&&page=<?php echo 'event.php';?>" onclick=" return window.confirm('Are you sure to delete');"><button type="button"  class="btn btn-danger" style="float: right;">Delete</button></a>
								</div>
							</div>
							<?php
						}
				...
				<div class="col-lg-2 col-md-2 date">
					...
					<input type="hidden" name="page" value="event.php">
				</form>
				</div>
...
<!--pagenation -->
  ...
  <a class="active" href="event.php">1</a>
  <a   href="event1.php">2</a>
  <a href="event2.php">3</a>
  <a href="event1.php">&raquo;</a>
</div>
</div>
