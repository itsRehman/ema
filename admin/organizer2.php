...
<body>
 ...
 $countorg=mysql_query("select count(organizer_email) from organizer")or die('count query error');
   ...
   $query=mysql_query(" select user.fristname,user.lastname,user.email,organizer.companyname,organizer.country,organizer.city,organizer.logo  from user join organizer where user.email=organizer.organizer_email  LIMIT 41,61") or die('organizer    table selection query error');
							...
							<table class="table">
								<tbody>
									...
									<tr>
										...
										<td> <a href="deleteorganizer.php?email=<?php echo $rows[2];?>&&page=<?php echo 'organizer2.php';?>" onclick="return window.confirm('Are you sure to delete')"> <button type="button" class="btn btn-danger">Delete</button></a></td>
									</tr>
...
<!--pagenation -->
   ...
   <a href="organizer1.php">&laquo;</a>
  <a href="organizer.php">1</a>
  <a  href="organizer1.php">2</a>
  <a  class="active" href="organizer2.php">3</a>
