...
<body>
			...
			<div class="row">
				...
				<div class="col-lg-9 col-md-9">
					<div class="panel panel-default">
						...
						<?php
						 $query=mysql_query(" select user.fristname,user.lastname,user.email,suggestion.subject,suggestion.suggestion,suggestion.ondate,user.profile_picture from user join suggestion where user.email=suggestion.email LIMIT 0,20 ") or die('suggestion    table selection query error');
							...
							<table class="table">
								<tbody>
									...
									<tr>
										...
										<img src="../profile_pictures/<?php echo $rows[6];?>" class="img-responsive img-circle">
										...
										<td><a href="deletesuggestion.php?email=<?php echo $rows[2];?>&&page=<?php echo 'suggestions.php';?>" onclick="return window.confirm('Are you sure to delete')"> <button type="button" class="btn btn-danger">Delete</button></a></td>
									</tr>
 ...
 <!--pagenation -->
  ...
  <a class="active" href="suggestions.php">1</a>
  <a   href="suggestion1.php">2</a>
  <a href="suggestion2.php">3</a>
  <a href="suggestion1.php">&raquo;</a>
</div>
</div>
