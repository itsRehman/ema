...
<body>
   ...
   $query=mysql_query(" select fristname,lastname,email,dateofbrith,joindate,profile_picture  from ema.user LIMIT 41,61 ") or die('user    table selection query error');
...
if(mysql_num_rows($query)>0){
							...
							<table class="table">
								<tbody>
									...
									<tr>
										...
										<td> <a href="deleteuser.php?email=<?php echo $rows[2];?>&&page=<?php echo 'user2.php';?>" onclick="return window.confirm('Are you sure to delete')"> <button type="button" class="btn btn-danger">Delete</button></a></td>
									</tr>
									<?php
								}
								?>
    ...
    <a href="user1.php">&laquo;</a>
  <a  href="user.php">1</a>
  <a   href="user1.php">2</a>
  <a class="active" href="user2.php">3</a>
