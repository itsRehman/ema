...
if(isset($_POST['pay'])){
	...
	exit();
		...
		$pay=mysql_query("INSERT INTO `ema`.`order_payment` (`order_no`, `sender_accoun_no`, `reciver_accoun_no`, `amount`, `date`) VALUES ('$orderno', '$accountnumber', '0', '$total', '$date')") or die("payment insertion query error");
		if(!$pay){
