...
#btn_upload_data{
 ...
 <?php
        ...
        <nav id="nav">
          <ul>
            <li><a href="#one" class="active">Upload your logo</a></li>
        ...
        <!-- Main -->
          <div id="main">
            ...
            <!-- One -->
              ...
              <div class="row">
                <div class="col-md-12">
                <h4 align="center"  style="color:#286E88;  ">Set company logo here..</h4>
					<br>
...
<div class="form-group">
  <label class="col-md-4 control-label" for="filebutton" style="color:#286E88;  ">Select logo</label>
...
<?php
 ...
 if(empty($image_name)){
   ...
   if($image_extension!="jpg"){
    echo "<script>alert(' logo formate is not valide')</script>";
     echo"<script>window.open('upload_company_logo.php','_self')</script>";
       exit();  
   }
	 else{
...
mysql_select_db('ema',$con);
	 ...
	 if(move_uploaded_file($image_tmp, "profile_pictures/$image_name")){
		 $q1=mysql_query(" UPDATE `ema`.`organizer` SET `logo`='$image_name' WHERE `organizer`.`organizer_email` = '$_SESSION[email]' ") or die('Q1 upload query erroe') ;
