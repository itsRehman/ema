							...
							<div class="well">
								<div class="row">
									...
									<div class="col-sm-9">
									 ...
									 <div id="comments-div" style="padding: 8px 16px 8px 16px">
											<?php
										...
										if(mysql_num_rows($reviewquery)>0){
										 while($review=mysql_fetch_array($reviewquery)){
										 	?>
					 							<div class="row" style="padding: 4px 8px 4px 8px">
										<div class="col-md-2" >
										...
										?>	 
												<img src="profile_pictures/<?php echo $reviewername[2];?>" class="img-responsive img-rounded" style="width: 100px; height: 80px;" />
										...
										<div class="col-md-10">
											...
											<div class="row">
												<div class="col-md-8">
													<strong style="font-weight: bolder; color:#307C94;position: relative; ">
													 <?php
						...
						<div class="col-md-3">
							...
							<div class="panel" style="font-size: 12px;">
									...
									$organizers= mysql_query("SELECT * FROM ema.`order` WHERE `event_id`='$id' and state='completed'")or die('organizer selection  query error');
										...
										<?php
										 $orgname= mysql_query("SELECT `fristname`,`lastname`,`profile_picture` FROM `user` WHERE email='$org[1]'")or die('org name selection  query error');
...
?>
	  ...
	  <center>There is no pictures of this event</center>
	  </font>
	  </p>
	  <?php	
}
...
?>
	  <p><font color="gray" size="5">
	  <center>There is no videos of this event</center>
	  </font>
	  </p>
	  <?php	
}
